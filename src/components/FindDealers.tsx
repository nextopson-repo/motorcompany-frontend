...
export default function FindDealers() {
  ...
  return (
    <section className="w-full lg:max-w-7xl h-[190px] sm:h-[200px] lg:h-[310px] flex items-center relative overflow-hidden">
      {/* Left Text Section */}
      <div className="lg:w-[58%] h-full px-2 lg:px-8 py-4 lg:py-12 flex flex-col justify-between bg-gradient-to-r from-sky-100 via-sky-200/60 to-pink-50/5 z-5">
        <div className="space-y-2 lg:space-y-3">
          <div className="flex items-center gap-2 sm:gap-4 text-xs sm:text-xs text-black">
          ...
          <h2 className="text-md sm:text-[1.1rem] lg:text-[1.6rem] font-bold text-gray-800">
            ...
            <span className="relative inline-block">
              ...
              <img
                ...
                alt="design"
                className="absolute -top-[6px] sm:-top-1 lg:-top-2 left-11 sm:left-14 lg:left-20 w-4 lg:w-8"
              />
            </span>
          </h2>

          <p className="text-gray-800 max-w-[78%] sm:max-w-[60%] lg:max-w-[85%] lg:max-w-auto text-xs sm:text-xs lg:text-sm leading-[1.5] lg:leading-4 tracking-tight">
        ...
        <div className="mb-2 lg:mb-0">
          <div
            ...
            className="inline-flex items-center text-black text-md lg:text-xl font-semibold tracking-wide underline underline-offset-2 group hover-scale-[1.05]"
          >
            Talk to the Dealers Now{" "}
            <ArrowRight className="ml-2 h-4 w-4 lg:h-7 lg:w-9 group-hover:ml-6 transition-all duration-300 ease-in-out" />
          </div>
        </div>
      </div>
