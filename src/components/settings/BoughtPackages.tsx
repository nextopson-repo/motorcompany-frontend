...
const BoughtPackages: React.FC = () => {
  ...
  return (
    <div className="w-full lg:w-3xl mx-auto bg-white rounded-lg shadow-none md:shadow-md">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center my-2 lg:my-0 md:mb-4 px-4 md:px-0">
      ...
      {/* Desktop Table */}
      <div className="hidden md:block overflow-x-auto rounded-md shadow-sm sm:mb-10 lg:mb-0 lg:mt-4">
