...
const Footer = () => {
  ...
  return (
    <footer className="w-full max-w-7xl mx-auto text-gray-800 border-t border-gray-300 px-6">
      {/* Main Grid */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-14 items-center border-b border-gray-300 py-6">
        {/* Logo + Description */}
        <div className="col-span-2 space-y-4 px-2">
          <img src="/Brand-logo.png" alt="Dhikkar" className="h-10 w-auto" />
          ...
          <span className="flex items-center gap-2 text-xs md:text-xs font-semibold group text-[#EE1422] hover:underline">
        ...
        <div className="">
          ...
          <ul className="space-y-1 text-[10px] md:text-[10px] xl:text-xs">
        ...
        <div className="mt-6">
          <ul className="space-y-1 text-[10px] md:text-[10px]">
        ...
        {/* Newsletter */}
        <div className="col-span-2 bg-[#CBCBCB] rounded-md p-3 space-y-2 mr-4">
          <img
            src="/Brand-logo.png"
            alt="Dhikkar-logo"
            className="h-6 w-auto"
          />
          <h4 className="text-[10px] font-semibold">Found Car in you City</h4>
          ...
          <a href="" className="text-xs flex gap-1">
            Start Explore{" "}
            <span>
              <ChevronRight className="h-4 w-4 text-gray-900 group-hover:ml-2 transition-all duration-500 cursor-pointer" />
            </span>
          </a>
        </div>
      </div>
      ...
      {/* Bottom Strip */}
      <div className="text-sm font-semibold text-center md:text-left text-gray-900 flex flex-col md:flex-row items-center justify-between py-5 px-2 max-w-7xl mx-auto gap-2">
        <p className="flex items-center gap-2"><Copyright className="h-5 w-5"/> Copyright {new Date().getFullYear()} | All Rights Reserved</p>
