...
//           <button
//             type="button"
//             className="bg-[#EE1422] text-white px-2 md:px-3 py-1 md:py-2 rounded-sm text-[10px] md:text-sm whitespace-nowrap flex items-center gap-2 cursor-pointer"
//           >
//             <svg
...
//         {/* location grid */}
//         <div className="w-full overflow-y-auto p-2 md:p-4 md:px-5 grid grid-cols-4 md:grid-cols-4 lg:grid-cols-5 ">
//           {filteredLocations.map((loc) => (
//             <button
//               key={loc}
