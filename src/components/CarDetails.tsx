    ...
    <div className="max-w-7xl mx-auto mt-12 lg:mt-20 z-0 lg:pt-2">
      ...
      <div className="relative h-fit lg:grid lg:grid-cols-13 lg:mx-6 lg:my-3 md:gap-6 ">
        ...
        <div className="lg:col-span-9 space-y-6">
          ...
          {/* desktop car overview table */}
          <div
            className="hidden lg:block bg-white lg:pt-4 border-b border-gray-100 pb-2 rounded-2xl border"
            style={{
          ...
          <div className="lg:hidden bg-white border border-gray-200 p-4 py-6 rounded-2xl space-y-3 shadow z-40 -mt-10">
            <div className="flex justify-between">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  className="text-red-500 flex flex-col items-center gap-1 cursor-pointer active:scale-95"
                  ...
                  <div className="py-2 px-2">
                    <div className="flex items-center gap-2 py-2">
                      ...
                      <div className="flex flex-col gap-2 w-full pb-1 pl-1">
                        ...
                        <p className="text-[#9e9e9e] bg-[#f4f4f4] p-0.5 px-1 rounded-sm text-[10px] w-fit">
                          {ownerType || "N/A"}
                        </p>
                      </div>
                    </div>
      ...
      <div className="pb-3 lg:p-6 rounded-2xl lg:rounded-none border lg:border-none border-gray-100 shadow-[0_1px_10px_1px_rgba(0,0,0,0.15)] lg:shadow-none">
        <div className="flex items-center justify-between mt-4 lg:mt-6 px-4 lg:px-0">
          ...
          <button
            ...
            className="flex items-center bg-black rounded-sm p-1.5 lg:p-2 px-3 lg:px-6 text-white gap-2 text-[10px] lg:text-base"
          >
            View All{" "}
