    ...
    <section className="max-w-7xl mx-auto px-2 lg:px-8 py-6 lg:py-14 relative">
      ...
      <div className="text-xs text-center mb-5 mx-auto">
        <p className="text-[#EE1422] text-[9px] md:text-xs font-bold mb-3 flex items-center justify-center gap-2 md:gap-5">
          <span className="w-7 md:w-10 h-[1px] bg-[#EE1422]" />
          Featured Cars
          <span className="w-7 md:w-10 h-[1px] bg-[#EE1422]" />
        </p>
        <h2 className="text-xs md:text-2xl font-bold">The Most Searched And Liked Cars</h2>
      </div>
      ...
      <div className="flex justify-center mt-4">
        <button
          className="w-[150px] md:w-[16.5rem] text-xs md:text-sm bg-[#EE1422] text-white font-medium py-[6px] md:py-2 rounded-sm hover:bg-[#EE1422]/80 transition"
