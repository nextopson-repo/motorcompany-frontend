...
//   console.log("state sell hero", uploadedImages); //issme file aa raha hai
...
//   // };
//   const handleImagesReceived = (files: File[]) => {
//     setUploadedImages(files); // state update for UI
//     handleFinalSubmit(files); // direct files pass karo submit me
//   };
...
//       console.warn("No images received for upload");
//       return;
//     }
...
//       console.log("received Appending file:", file.name); // debugging
//       formData.append("carImages", file);
//     });
...
//     //     console.log("carData Appending file:", file.name, file.size); // ye wala log kabhi dhikha hi nahi
//     //     formData.append("carImages", file);
//     //   });
//     // }

//     // // console.log("image :", uploadedImages); // image debugging ye bhi blank aa raha hai
...
//                 handleImagesReceived(carData.images || []);
//               }}
//               defaultValues={editCar}
//               uploadedImages={uploadedImages}
