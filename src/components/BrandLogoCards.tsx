...
const BrandLogoCards: React.FC = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto relative bg-[#F8F8F8] px-4 lg:px-0 py-6 md:py-8 md:pb-12  bg-car-handle">
      {/* Top Heading */}
      <div className="mb-5 md:mb-8 mx-auto md:px-10">
        <h2 className=" text-[17px] md:text-2xl font-semibold">
          Popular Brands
        </h2>
      </div>
      ...
      <div className="md:px-10">
        ...
        >
          {brandLogos.map((car, idx) => (
            <SwiperSlide key={idx}>
              <div
                className="bg-white rounded-sm p-2 md:p-4"
      ...
      <button className="custom-next3 absolute right-[3%] md:right-4 top-[60%] sm:top-[60%] -translate-y-1/2 z-30 bg-gray-500 md:bg-gray-900 text-white shadow-lg p-1 md:p-2 rounded-full hover:bg-gray-700 cursor-pointer">
