  ...
  return (
    <section className="w-full mt-2 md:mt-6">
      ...
      <div className="text-center py-4">
        <p className="text-[9px] md:text-xs text-[#EE1422] font-semibold mb-2 md:mb-4 flex items-center justify-center gap-5">
          <span className="w-8 md:w-10 h-[1px] md:h-[1.5px] bg-[#EE1422]"></span>
          Categories
          <span className="w-8 md:w-10 h-[1px] md:h-[1.5px] bg-[#EE1422]"></span>
        </p>
        <h2 className="text-sm md:text-[1.6rem] tracking-wide font-bold md:font-semibold ">
        ...
        {bodyTypes.map((type) => (
          ...
          >
            ...
            <span className="flex flex-col items-center">
              ...
              <span className="text-gray-500 text-[7px] md:text-[9px]">
      ...
      <section className="max-w-7xl mx-auto px-2 md:px-8 py-10 relative">
        ...
        <div className="text-[9px] md:text-sm text-center mb-3 md:mb-5 mx-auto">
          <p className="text-[#EE1422] text-[9px] md:text-xs font-semibold mb-2 md:mb-5 flex items-center justify-center gap-3 md:gap-5">
            <span className="w-7 md:w-10 h-[1px] md:h-[1.2px] bg-[#EE1422]"></span>
            Recently Added Cars
            <span className="w-7 md:w-10 h-[1px] md:h-[1.2px] bg-[#EE1422]"></span>
          </p>
