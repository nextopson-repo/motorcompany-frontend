        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-8">
          ...
          <div ref={dropdownRef} className="relative w-full md:w-48">
            <button
              ...
              className="w-full bg-black text-white border border-gray-700 rounded-md px-4 py-2 flex justify-between items-center"
            >
              ...
              <div className="absolute mt-1 w-full bg-white border border-gray-700 rounded-md shadow-lg z-10 max-h-60 overflow-auto">
                {cities.map((city) => (
                  <div
                    ...
                    className="px-4 py-2 cursor-pointer hover:bg-gray-300 text-black"
                  >
                    {city}
                  </div>
                ))}
      ...
      <div className="max-w-5xl mx-auto pt-10">
        ...
        {dealers.map((dealer) => (
          ...
          >
            ...
            <button className="mt-4 md:mt-0 bg-black text-white px-4 py-2 rounded hover:bg-black/80 flex items-center gap-3">
